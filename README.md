...
**Phase 0 complete — documentation baseline.** No application code yet.

The full specification lives in [`docs/`](./docs) and is the source of truth for this project. Implementation begins with Phase 1 (Platform Foundation) per [`docs/TODO.md`](./docs/TODO.md).
